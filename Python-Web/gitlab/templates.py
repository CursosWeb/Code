# HTML Templates for GitLab Issues Viewer
...
<head>
    ...
    <title>GitLab Issues Viewer</title>
    <style>
        body {{
...
<body>
    <div class="container">
        ...
        <form action="/issues" method="GET">
            ...
            <button type="submit">Ver Issues</button>
        </form>
    </div>
</body>
</html>
...
<head>
    ...
    <style>
        ...
        .error {{ color: #d9534f; background-color: #f9f2f2; padding: 20px; border-radius: 5px; }}
        .back {{ margin-top: 20px; }}
        a {{ color: #fc6d26; text-decoration: none; }}
    </style>
</head>
<body>
    <div class="error">
        <h2>❌ Error al obtener los issues</h2>
        <p>No se pudieron obtener los issues del repositorio <strong>{repo_name}</strong></p>
